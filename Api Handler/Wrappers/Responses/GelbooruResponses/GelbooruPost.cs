...
namespace Big_Seed_Bot.Api_Handler.Wrappers.Responses.GelbooruResponses;


public class GelbooruPostRoot : IResponse
{
    [JsonPropertyName("@attributes")]
    public GelbooruPostAttribute? Attribute { get; set; }
...
public class GelbooruPostAttribute
{
